...
#define SB_BRCM_BST_STAT_ID_DEVICE_DEFAULT (0x55C8 * 208)
...
#define SB_BRCM_BST_STAT_ID_PORT_POOL_DEFAULT (0x4EC5 * 208)
#define SB_BRCM_BST_STAT_ID_ING_POOL_DEFAULT (0x21FC * 208)
#define SB_BRCM_BST_STAT_ID_EGR_UCAST_PORT_SHARED_DEFAULT  (0x4EC5 * 208)
#define SB_BRCM_BST_STAT_ID_EGR_PORT_SHARED_DEFAULT (0x4EC5 * 208)
#define SB_BRCM_BST_STAT_ID_EGR_MCAST_PORT_SHARED_DEFAULT  (0x4EC5 * 208)
#define SB_BRCM_BST_STAT_ID_EGR_POOL_DEFAULT (0x4D0D * 208)
#define SB_BRCM_BST_STAT_ID_EGR_MCAST_POOL_DEFAULT (0x4D0D * 208)
#define SB_BRCM_BST_STAT_ID_UCAST_DEFAULT (0x4D0D * 208)
#define SB_BRCM_BST_STAT_ID_UCAST_GROUP_DEFAULT (0x4D0D * 208)
#define SB_BRCM_BST_STAT_ID_MCAST_DEFAULT (0x4D0D * 208)
#define SB_BRCM_BST_STAT_ID_CPU_DEFAULT (0x4D0D * 208)
#define SB_BRCM_BST_STAT_ID_RQE_QUEUE_DEFAULT (0x4D0D * 208)
#define SB_BRCM_BST_STAT_ID_RQE_POOL_DEFAULT (0x4D0D * 208)
